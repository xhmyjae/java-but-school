...
public class CarteMonstrePanel extends JPanel {
    ...
    public void initialize() {
        ...
        Monstre monstre = new Monstre("Invocateur Dragon Bleu","Si cette carte est envoyée depuis le Terrain au Cimetière : vous pouvez ajouter 1 Monstre Normal de Type Dragon/ Guerrier/Magicien depuis votre Deck à votre main.", "YS14-FR017",4, EnumAttributsMonstre.attribut.VENT, "Magicien/Effet", 1500, 600);
